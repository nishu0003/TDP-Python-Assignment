...
cur.execute(s)"""        #hete i made student details table and define them

n=int(input("How many Students data you want to add : "))             #here we will how many students data we want to add in our database.
